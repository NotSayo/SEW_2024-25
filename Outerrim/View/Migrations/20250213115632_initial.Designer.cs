...
namespace View.Migrations
{
    ...
    [Migration("20250213115632_initial")]
            ...
            modelBuilder.Entity("Model.Entities.EnvironmentalSystem", b =>
                {
                    ...
                    b.ToTable("EnvironmentalSystems", (string)null);
                });
            ...
            modelBuilder.Entity("Model.Entities.EnvironmentalSystem", b =>
                {
                    b.HasOne("Model.Entities.Machinery", null)
                        .WithOne()
                        .HasForeignKey("Model.Entities.EnvironmentalSystem", "MachineryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Model.Entities.Weapons", b =>
                {
                    b.HasOne("Model.Entities.Machinery", null)
                        .WithOne()
                        .HasForeignKey("Model.Entities.Weapons", "MachineryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
